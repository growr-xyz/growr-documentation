...
- Optionally request and ensure that the Borrower has the necessary credit score</ul>
...
- Eligibility check:
  * By receiving confirmation of the verification result from the Verification Registry smart contract</ul>
